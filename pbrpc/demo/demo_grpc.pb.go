...
const (
	MyService_MyMethod_FullMethodName = "/demo.MyService/MyMethod"
)
...
type MyServiceClient interface {
	MyMethod(ctx context.Context, in *MyMessage, opts ...grpc.CallOption) (*MyMessage, error)
}
...
func (c *myServiceClient) MyMethod(ctx context.Context, in *MyMessage, opts ...grpc.CallOption) (*MyMessage, error) {
	out := new(MyMessage)
...
func _MyService_MyMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MyServiceServer).MyMethod(ctx, req.(*MyMessage))
	}
